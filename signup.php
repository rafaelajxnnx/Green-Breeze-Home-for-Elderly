...
<head>
  ...
  <link href='https://fonts.googleapis.com/css?family=Titillium+Web:40s0,300,600' rel='stylesheet' type='text/css'>  
...
<body>
    <div class="login-page">
        <form class="form">
                <p class="greenbreeze-name" style="font-size: 25px; margin-bottom: -15px; margin-top: 0px">REGISTER ADMIN</p>
