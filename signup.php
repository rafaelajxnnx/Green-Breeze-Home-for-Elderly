...
<body>
    ...
    <script>
        ...
        addAdminformEl.addEventListener('submit', event => {
            ...
            fetch('https://rafaelajxnnxx-001-site1.ftempurl.com/api/User/signup', {
                method: 'Post',
                // headers: {
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    editIcon.addEventListener('click', () => {
                        ...
                        fetch('https://rafaelajxnnxx-001-site1.ftempurl.com/api/User/GetUser/' + item.id)
                            ...
                            .then(data => {
                                ...
                                updateMedicineformEl.addEventListener('submit', event => {
                                    ...
                                    fetch('https://rafaelajxnnxx-001-site1.ftempurl.com/User/UpdateUserInfo/' + itemId, {
                                        method: 'PUT',
                                        //headers: {
                                        //	'Content-Type': 'application/json'
                                        //},
                    ...
                    deleteIcon.addEventListener('click', () => {
                        ...
                        fetch('https://rafaelajxnnxx-001-site1.ftempurl.com/api/User/DeleteUser/' + item.id, {
                            method: 'DELETE'
                        })
                            .then(response => {
                                if (!response.ok) {
